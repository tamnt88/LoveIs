<%@ Page Language="C#" AutoEventWireup="true" CodeFile="default.aspx.cs" Inherits="AdminCmsPagesDefault" MasterPageFile="~/admin/admin.master" %>
...
<asp:Content ID="SubHeadingContent" ContentPlaceHolderID="PageSubHeading" runat="server">
    Quản lý nội dung và SEO cho trang tĩnh
</asp:Content>
...
<asp:Content ID="MainContent" ContentPlaceHolderID="MainContent" runat="server">
    <div class="card-kpi p-3 bg-white">
        <div class="admin-filters mb-3">
            <div class="row g-2">
                <div class="col-md-6">
                    ...
                    <input type="text" id="filterKeyword" class="form-control" placeholder="Nhập tên trang hoặc slug" />
                </div>
                <div class="col-md-4">
        ...
        <div class="d-flex justify-content-between align-items-center mb-3">
            <h6 class="mb-0 section-title">Danh sách trang tĩnh</h6>
            <a href="/admin/cms/pages/edit.aspx" class="btn btn-primary btn-with-icon">
        ...
        <div class="table-responsive">
            <table id="staticPageTable" class="table table-striped align-middle">
                <thead>
                    <tr>
                        <th>Trang</th>
                        <th>Slug</th>
...
<asp:Content ID="PageScripts" ContentPlaceHolderID="PageScripts" runat="server">
    ...
    <script>
        (function ($) {
            ...
            var table = $("#staticPageTable").DataTable({
                pageLength: 25,
                order: [[2, "asc"]],
                serverSide: true,
                processing: true,
                ...
                columnDefs: [
                    { targets: [3, 4], render: function (data) { return data; } },
            ...
            window.deleteStaticPage = function (id) {
                if (!confirm("Xóa trang này?")) {
                    return;
                }

                $.ajax({
                    url: "default.aspx/DeletePage",
                    type: "POST",
                    contentType: "application/json; charset=utf-8",
