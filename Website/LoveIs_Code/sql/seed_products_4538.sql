...
BEGIN TRY
    ...
    DECLARE @RootCategoryId INT = 4538;
    ...
    BEGIN
        THROW 50001, N'Không tìm thấy danh mục con/cha cho Id 4538.', 1;
    END
    ...
    SELECT
        p.Id,
        NULL,
        N'/upload/products/images/4538/' + CAST(n.Number AS NVARCHAR(10)) + N'.webp',
