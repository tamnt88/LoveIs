<%@ Page Language="C#" AutoEventWireup="true" CodeFile="default.aspx.cs" Inherits="AdminProductBrandsDefault" MasterPageFile="~/admin/admin.master" %>
...
<asp:Content ID="MainContent" ContentPlaceHolderID="MainContent" runat="server">
    <div class="card-kpi p-3 bg-white">
        <div class="admin-filters mb-3">
            <div class="row g-2">
                <div class="col-md-4">
                    ...
                    <input type="text" id="filterName" class="form-control" placeholder="Nhập tên thương hiệu" />
                </div>
                <div class="col-md-3">
        ...
        <div class="d-flex justify-content-between align-items-center mb-3">
            ...
            <a href="/admin/products/brands/edit.aspx" class="btn btn-primary btn-with-icon">
        ...
        <div class="table-responsive">
            <table id="brandTable" class="table table-striped align-middle">
                <thead>
                    <tr>
                        <th>Thương hiệu</th>
                        <th>Lượt xem</th>
