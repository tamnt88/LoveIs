<%@ Page Language="C#" AutoEventWireup="true" CodeFile="edit.aspx.cs" Inherits="AdminProductBrandsEdit" MasterPageFile="~/admin/admin.master" ValidateRequest="false" %>
...
<asp:Content ID="BreadcrumbContent" ContentPlaceHolderID="PageBreadcrumb" runat="server">
    ...
    <li class="breadcrumb-item"><a href="/admin/products/brands/default.aspx">Thương hiệu</a></li>
    ...
    <div class="row g-3">
        <div class="col-lg-12">
            <div class="card-kpi p-3 bg-white">
                <h6 class="mb-3 section-title">Thông tin thương hiệu</h6>
    ...
    <li class="nav-item" role="presentation">
        <button class="nav-link" id="tab-setting" data-bs-toggle="tab" data-bs-target="#tab-setting-pane" type="button" role="tab"><i class="fa-solid fa-gear"></i> Thi&#7871;t l&#7853;p</button>
                ...
                <div class="tab-content border border-top-0 rounded-bottom p-3">
                    <div class="tab-pane fade show active" id="tab-basic-pane" role="tabpanel">
                        <div class="mb-3">
                            ...
                            <asp:TextBox ID="BrandNameInput" runat="server" CssClass="form-control"></asp:TextBox>
                        </div>
                        <div class="mb-3">
                    ...
                    <div class="tab-pane fade" id="tab-seo-pane" role="tabpanel">
                        ...
                        <div class="mb-3">
                            ...
                            <asp:TextBox ID="SeoSlugInput" runat="server" CssClass="form-control" placeholder="vi-du-thuong-hieu"></asp:TextBox>
                        </div>
                        <div class="mb-3">
                ...
                <div class="d-flex gap-2 mt-3">
                    ...
                    <a href="/admin/products/brands/default.aspx" class="btn btn-outline-dark btn-with-icon">
