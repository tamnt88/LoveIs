...
BEGIN TRY
    ...
    DECLARE @RootCategoryId INT = 4539;
    ...
    BEGIN
        THROW 50001, N'Không tìm thấy danh mục con/cha cho Id 4539.', 1;
    END
    ...
    SELECT
        p.Id,
        NULL,
        N'/upload/products/images/4539/' + CAST(n.Number AS NVARCHAR(10)) + N'.webp',
