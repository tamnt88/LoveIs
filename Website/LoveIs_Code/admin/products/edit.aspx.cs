...

{
...

    {
...

        {
            ...
            ShopInput.Items.Clear();
            ShopInput.Items.Add(new ListItem("Chọn cửa hàng", ""));
            foreach (var item in shops)
            {
                ShopInput.Items.Add(new ListItem(item.ShopName, item.Id.ToString()));
            }}
...

    {
...

        {
            ...
            return;
                ...
                int shopId;
        if (!int.TryParse(ShopInput.SelectedValue, out shopId) || shopId <= 0)
        {
            FormMessage.Text = "Vui lòng chọn cửa hàng.";
            return;
        }
int categoryId;
...

    {
...

        {
            ...
            SelectDropdown(ShopInput, product.ShopId);
