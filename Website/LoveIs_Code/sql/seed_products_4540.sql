...
BEGIN TRY
    ...
    DECLARE @RootCategoryId INT = 4540;
    ...
    BEGIN
        THROW 50001, N'Không tìm thấy danh mục con/cha cho Id 4540.', 1;
    END
    ...
    SELECT
        p.Id,
        NULL,
        N'/upload/products/images/4540/' + CAST(n.Number AS NVARCHAR(10)) + N'.webp',
