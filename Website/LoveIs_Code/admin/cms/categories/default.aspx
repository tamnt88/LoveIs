<%@ Page Language="C#" AutoEventWireup="true" CodeFile="default.aspx.cs" Inherits="AdminCmsCategoriesList" MasterPageFile="~/admin/admin.master" ResponseEncoding="utf-8" %>
...
<asp:Content ID="SubHeadingContent" ContentPlaceHolderID="PageSubHeading" runat="server">
    Quản lý danh mục bài viết/trang nội dung
</asp:Content>
...
<asp:Content ID="MainContent" ContentPlaceHolderID="MainContent" runat="server">
    <div class="card-kpi p-3 bg-white">
        <div class="admin-filters mb-3">
            <div class="row g-2">
                ...
                <div class="col-md-4">
                    ...
                    <asp:DropDownList ID="ParentFilter" runat="server" CssClass="form-select"></asp:DropDownList>
                </div>
                <div class="col-md-2">
        ...
        <div class="d-flex justify-content-between align-items-center mb-3">
            <h6 class="mb-0 section-title">Danh sách danh mục bài viết</h6>
            <a class="btn btn-primary btn-with-icon" href="/admin/cms/categories/edit.aspx">
                <i class="fa-solid fa-plus"></i> Thêm danh mục
            </a>
        </div>
        <asp:Label ID="ListMessage" runat="server" CssClass="text-danger small d-block mb-2"></asp:Label>
        <div class="table-responsive">
            <table id="cmsCategoryTable" class="table table-striped align-middle">
                <thead>
                    <tr>
                        <th>Tên danh mục</th>
                        <th>Danh mục cha</th>
...
<asp:Content ID="PageScripts" ContentPlaceHolderID="PageScripts" runat="server">
    ...
    <script>
        (function ($) {
            ...
            var table = $("#cmsCategoryTable").DataTable({
                pageLength: 25,
                order: [[3, "asc"]],
                serverSide: true,
                processing: true,
                ajax: {
                    ...
                    data: function (d) {
                        return JSON.stringify({
                            ...
                            parentId: $("#<%= ParentFilter.ClientID %>").val(),
            ...
            window.deleteCmsCategory = function (id) {
