...
BEGIN TRY
    ...
    DECLARE @RootCategoryId INT = 4532;
    ...
    BEGIN
        THROW 50001, N'Không tìm thấy danh mục con/cha cho Id 4532.', 1;
    END
    ...
    SELECT
        p.Id,
        NULL,
        N'/upload/products/images/4532/' + CAST(n.Number AS NVARCHAR(10)) + N'.webp',
