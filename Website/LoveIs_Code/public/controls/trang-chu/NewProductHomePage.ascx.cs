...
public partial class public_controls_trang_chu_NewProductHomePage : System.Web.UI.UserControl
{
    ...
    private static string BuildPriceHtml(PriceInfo priceInfo)
    {
        ...
        {
            return string.Format("<span>{0}</span>", FormatMoney(priceInfo.Sale));
        }
    ...
    private static string BuildDiscountBadge(PriceInfo priceInfo)
    {
        ...
        return string.Format("<span class='new-product-sale'>Giảm {0}%</span>", percent);
    }
    ...
    private class BestSellingProductView
    {
