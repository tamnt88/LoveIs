<%@ Page Language="C#" AutoEventWireup="true" CodeFile="default.aspx.cs" Inherits="AdminProductFiltersDefault" MasterPageFile="~/admin/admin.master" %>
...
<asp:Content ID="MainContent" ContentPlaceHolderID="MainContent" runat="server">
    <div class="card-kpi p-3 bg-white">
        <div class="admin-filters mb-3">
            <div class="row g-2">
                <div class="col-md-4">
                    ...
                    <input type="text" id="filterName" class="form-control" placeholder="Nhập tên nhóm lọc" />
                </div>
                <div class="col-md-3">
        ...
        <div class="d-flex justify-content-between align-items-center mb-3">
            <h6 class="mb-0 section-title">Danh sách nhóm lọc</h6>
            <a href="/admin/products/filters/edit.aspx" class="btn btn-primary btn-with-icon">
                <i class="fa-solid fa-plus"></i> Thêm nhóm lọc
            </a>
        </div>
    ...
    <script>
        (function ($) {
            ...
            var table = $("#filterTable").DataTable({
                ...
                processing: true,
                ajax: {
                    url: "default.aspx/GetFilterGroups",
                    type: "POST",
            ...
            window.deleteFilterGroup = function (id) {
                if (!confirm("Xóa nhóm lọc này?")) {
                    return;
                }

                $.ajax({
                    url: "default.aspx/DeleteFilterGroup",
                    type: "POST",
                    contentType: "application/json; charset=utf-8",
