...
public partial class NewArrivalDefault : System.Web.UI.Page
{
    ...
    private void BindPage()
    {
        ...
        using (var db = new BeautyStoryContext())
        {
            ...
            PageSummaryLiteral.Text = "Xem " + totalProducts + " sản phẩm mới";
            ...
            SeoTitleLiteral.Text = "Hàng mới về | LoveIs Store";
