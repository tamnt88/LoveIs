<%@ Page Language="C#" AutoEventWireup="true" CodeFile="default.aspx.cs" Inherits="AdminProductOriginsDefault" MasterPageFile="~/admin/admin.master" %>
...
<asp:Content ID="MainContent" ContentPlaceHolderID="MainContent" runat="server">
    <div class="card-kpi p-3 bg-white">
        <div class="admin-filters mb-3">
            <div class="row g-2">
                <div class="col-md-4">
                    ...
                    <input type="text" id="filterName" class="form-control" placeholder="Nhập tên xuất xứ" />
                </div>
                <div class="col-md-3">
        ...
        <div class="d-flex justify-content-between align-items-center mb-3">
            <h6 class="mb-0 section-title">Danh sách xuất xứ</h6>
            <a href="/admin/products/origins/edit.aspx" class="btn btn-primary btn-with-icon">
        ...
        <div class="table-responsive">
            <table id="originTable" class="table table-striped align-middle">
                <thead>
                    <tr>
                        <th>Xuất xứ</th>
                        <th>Lượt xem</th>
    ...
    <script>
        (function ($) {
            ...
            window.deleteOrigin = function (id) {
                if (!confirm("Xóa xuất xứ này?")) {
                    return;
                }

                $.ajax({
                    url: "default.aspx/DeleteOrigin",
                    type: "POST",
                    contentType: "application/json; charset=utf-8",
