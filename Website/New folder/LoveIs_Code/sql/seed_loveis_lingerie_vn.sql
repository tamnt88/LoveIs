...
BEGIN TRY
    ...
    VALUES
        ...
        (@CatBralette, @GroupSize, 1, @Now, @SeedBy, 1),
        (@CatBralette, @GroupCup, 1, @Now, @SeedBy, 2),
        (@CatBralette, @GroupColor, 1, @Now, @SeedBy, 3),
        (@CatBralette, @GroupMaterial, 1, @Now, @SeedBy, 4),
        (@CatBralette, @GroupStyle, 1, @Now, @SeedBy, 5),
        ...
        (@CatThong, @GroupSize, 1, @Now, @SeedBy, 1),
        (@CatThong, @GroupColor, 1, @Now, @SeedBy, 2),
        (@CatThong, @GroupMaterial, 1, @Now, @SeedBy, 3),
        (@CatThong, @GroupStyle, 1, @Now, @SeedBy, 4),
        (@CatSeamless, @GroupSize, 1, @Now, @SeedBy, 1),
        (@CatSeamless, @GroupColor, 1, @Now, @SeedBy, 2),
        (@CatSeamless, @GroupMaterial, 1, @Now, @SeedBy, 3),
        (@CatSeamless, @GroupStyle, 1, @Now, @SeedBy, 4),
        (@CatSportBra, @GroupSize, 1, @Now, @SeedBy, 1),
        (@CatSportBra, @GroupCup, 1, @Now, @SeedBy, 2),
        (@CatSportBra, @GroupColor, 1, @Now, @SeedBy, 3),
        (@CatSportBra, @GroupMaterial, 1, @Now, @SeedBy, 4),
        (@CatSportBra, @GroupStyle, 1, @Now, @SeedBy, 5),
        (@CatMenBoxer, @GroupSize, 1, @Now, @SeedBy, 1),
        (@CatMenBoxer, @GroupColor, 1, @Now, @SeedBy, 2),
        (@CatMenBoxer, @GroupMaterial, 1, @Now, @SeedBy, 3),
        (@CatMenBoxer, @GroupStyle, 1, @Now, @SeedBy, 4),
        (@CatMenBrief, @GroupSize, 1, @Now, @SeedBy, 1),
        (@CatMenBrief, @GroupColor, 1, @Now, @SeedBy, 2),
        (@CatMenBrief, @GroupMaterial, 1, @Now, @SeedBy, 3),
        (@CatMenBrief, @GroupStyle, 1, @Now, @SeedBy, 4),
        (@CatMenTank, @GroupSize, 1, @Now, @SeedBy, 1),
        (@CatMenTank, @GroupColor, 1, @Now, @SeedBy, 2),
        (@CatMenTank, @GroupMaterial, 1, @Now, @SeedBy, 3),
        (@CatMenTank, @GroupStyle, 1, @Now, @SeedBy, 4),
        (@CatMenSet, @GroupSize, 1, @Now, @SeedBy, 1),
        (@CatMenSet, @GroupColor, 1, @Now, @SeedBy, 2),
        (@CatMenSet, @GroupMaterial, 1, @Now, @SeedBy, 3),
        (@CatMenSet, @GroupStyle, 1, @Now, @SeedBy, 4),
        (@CatShaperBodysuit, @GroupSize, 1, @Now, @SeedBy, 1),
        (@CatShaperBodysuit, @GroupColor, 1, @Now, @SeedBy, 2),
        (@CatShaperBodysuit, @GroupMaterial, 1, @Now, @SeedBy, 3),
        (@CatShaperBodysuit, @GroupStyle, 1, @Now, @SeedBy, 4),
        (@CatShaperCorset, @GroupSize, 1, @Now, @SeedBy, 1),
        (@CatShaperCorset, @GroupColor, 1, @Now, @SeedBy, 2),
        (@CatShaperCorset, @GroupMaterial, 1, @Now, @SeedBy, 3),
        (@CatShaperCorset, @GroupStyle, 1, @Now, @SeedBy, 4),
        (@CatSleepDress, @GroupSize, 1, @Now, @SeedBy, 1),
        (@CatSleepDress, @GroupColor, 1, @Now, @SeedBy, 2),
        (@CatSleepDress, @GroupMaterial, 1, @Now, @SeedBy, 3),
        (@CatSleepDress, @GroupStyle, 1, @Now, @SeedBy, 4),
        (@CatSleepSet, @GroupSize, 1, @Now, @SeedBy, 1),
        (@CatSleepSet, @GroupColor, 1, @Now, @SeedBy, 2),
        (@CatSleepSet, @GroupMaterial, 1, @Now, @SeedBy, 3),
        (@CatSleepSet, @GroupStyle, 1, @Now, @SeedBy, 4),
        (@CatPhuKienDayAo, @GroupColor, 1, @Now, @SeedBy, 1),
        (@CatPhuKienDayAo, @GroupMaterial, 1, @Now, @SeedBy, 2),
        (@CatPhuKienDayAo, @GroupStyle, 1, @Now, @SeedBy, 3),
        (@CatPhuKienMiengDan, @GroupColor, 1, @Now, @SeedBy, 1),
        (@CatPhuKienMiengDan, @GroupMaterial, 1, @Now, @SeedBy, 2),
        (@CatPhuKienMiengDan, @GroupStyle, 1, @Now, @SeedBy, 3),
        (@CatPhuKienVo, @GroupColor, 1, @Now, @SeedBy, 1),
        (@CatPhuKienVo, @GroupMaterial, 1, @Now, @SeedBy, 2),
        (@CatPhuKienVo, @GroupStyle, 1, @Now, @SeedBy, 3),
        (@CatDoNhaSet, @GroupSize, 1, @Now, @SeedBy, 1),
        (@CatDoNhaSet, @GroupColor, 1, @Now, @SeedBy, 2),
        (@CatDoNhaSet, @GroupMaterial, 1, @Now, @SeedBy, 3),
        (@CatDoNhaSet, @GroupStyle, 1, @Now, @SeedBy, 4),
        (@CatDoNhaVay, @GroupSize, 1, @Now, @SeedBy, 1),
        (@CatDoNhaVay, @GroupColor, 1, @Now, @SeedBy, 2),
        (@CatDoNhaVay, @GroupMaterial, 1, @Now, @SeedBy, 3),
        (@CatDoNhaVay, @GroupStyle, 1, @Now, @SeedBy, 4);
