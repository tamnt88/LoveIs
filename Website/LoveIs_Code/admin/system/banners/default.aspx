<%@ Page Language="C#" AutoEventWireup="true" CodeFile="default.aspx.cs" Inherits="AdminSystemBannersDefault" MasterPageFile="~/admin/admin.master" %>
...
<asp:Content ID="MainContent" ContentPlaceHolderID="MainContent" runat="server">
    <div class="card-kpi p-3 bg-white">
        <div class="admin-filters mb-3">
            <div class="row g-2">
                <div class="col-md-4">
                    ...
                    <input type="text" id="filterTitle" class="form-control" placeholder="Nhập tiêu đề" />
                </div>
                <div class="col-md-3">
        ...
        <div class="d-flex justify-content-between align-items-center mb-3">
            <h6 class="mb-0 section-title">Danh sách banner</h6>
            <a href="/admin/system/banners/edit.aspx" class="btn btn-primary btn-with-icon">
        ...
        <div class="table-responsive">
            <table id="bannerTable" class="table table-striped align-middle">
                <thead>
                    <tr>
                        <th>Hình</th>
                        <th>Tiêu đề</th>
        ...
        (function ($) {
            ...
            var table = $("#bannerTable").DataTable({
                ...
                columnDefs: [
                    ...
                    { targets: [0, 4], render: function (data) { return data; } }
                ],
                searching: false,
                lengthChange: false,
                language: {
