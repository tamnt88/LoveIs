<%@ Page Language="C#" AutoEventWireup="true" CodeFile="edit.aspx.cs" Inherits="AdminProductOriginsEdit" MasterPageFile="~/admin/admin.master" ValidateRequest="false" %>
...
<asp:Content ID="BreadcrumbContent" ContentPlaceHolderID="PageBreadcrumb" runat="server">
    ...
    <li class="breadcrumb-item"><a href="/admin/products/origins/default.aspx">Xuất xứ</a></li>
    ...
    <div class="row g-3">
        <div class="col-lg-12">
            <div class="card-kpi p-3 bg-white">
                <h6 class="mb-3 section-title">Thông tin xuất xứ</h6>
                <asp:Label ID="FormMessage" runat="server" CssClass="text-danger small d-block mb-2"></asp:Label>
                <asp:HiddenField ID="OriginId" runat="server" />
                ...
                <div class="tab-content border border-top-0 rounded-bottom p-3">
                    <div class="tab-pane fade show active" id="tab-basic-pane" role="tabpanel">
                        <div class="mb-3">
                            ...
                            <asp:TextBox ID="OriginNameInput" runat="server" CssClass="form-control"></asp:TextBox>
                        </div>
                        <div class="mb-3">
                    ...
                    <div class="tab-pane fade" id="tab-seo-pane" role="tabpanel">
                        ...
                        <div class="mb-3">
                            ...
                            <asp:TextBox ID="SeoSlugInput" runat="server" CssClass="form-control" placeholder="vi-du-xuat-xu"></asp:TextBox>
                        </div>
                        <div class="mb-3">
                    ...
                    <div class="tab-pane fade" id="tab-setting-pane" role="tabpanel">
                        <div class="row g-2 align-items-end">
                            ...
                            <div class="col-md-3">
                                ...
                                <asp:TextBox ID="ViewCountInput" runat="server" CssClass="form-control" Text="0"></asp:TextBox>
                            </div>
                            <div class="col-md-6">
                ...
                <div class="d-flex gap-2 mt-3">
                    ...
                    <a href="/admin/products/origins/default.aspx" class="btn btn-outline-dark btn-with-icon">
