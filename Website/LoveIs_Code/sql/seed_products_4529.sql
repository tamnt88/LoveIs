...
BEGIN TRY
    ...
    DECLARE @RootCategoryId INT = 4529;
    ...
    BEGIN
        THROW 50001, N'Không tìm thấy danh mục con/cha cho Id 4529.', 1;
    END
    ...
    SELECT
        p.Id,
        NULL,
        N'/upload/products/images/4529/' + CAST(n.Number AS NVARCHAR(10)) + N'.webp',
