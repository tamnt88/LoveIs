<%@ Page Language="C#" AutoEventWireup="true" CodeFile="default.aspx.cs" Inherits="AdminSystemBrandShowcasesDefault" MasterPageFile="~/admin/admin.master" %>

<asp:Content ID="TitleContent" ContentPlaceHolderID="PageTitle" runat="server">
    Quản lý thương hiệu tiêu biểu
</asp:Content>
...
<asp:Content ID="SubHeadingContent" ContentPlaceHolderID="PageSubHeading" runat="server">
    Danh sách thương hiệu hiển thị ngoài trang chủ
</asp:Content>
<asp:Content ID="BreadcrumbContent" ContentPlaceHolderID="PageBreadcrumb" runat="server">
    ...
    <li class="breadcrumb-item active" aria-current="page">Thương hiệu tiêu biểu</li>
</asp:Content>
...
<asp:Content ID="MainContent" ContentPlaceHolderID="MainContent" runat="server">
    <div class="card-kpi p-3 bg-white">
        <div class="admin-filters mb-3">
            <div class="row g-2">
                <div class="col-md-5">
                    ...
                    <asp:DropDownList ID="BrandFilter" runat="server" CssClass="form-select"></asp:DropDownList>
                </div>
                <div class="col-md-3">
        ...
        <div class="d-flex justify-content-between align-items-center mb-3">
            <h6 class="mb-0 section-title">Danh sách thương hiệu</h6>
            <a href="/admin/system/brand-showcases/edit.aspx" class="btn btn-primary btn-with-icon">
        ...
        <div class="table-responsive">
            <table id="showcaseTable" class="table table-striped align-middle">
                <thead>
                    <tr>
                        <th>Thương hiệu</th>
                        <th>Tiêu đề</th>
...
<asp:Content ID="PageScripts" ContentPlaceHolderID="PageScripts" runat="server">
    ...
    <script>
        (function ($) {
            ...
            var table = $("#showcaseTable").DataTable({
                pageLength: 25,
                order: [[3, "asc"]],
                serverSide: true,
                processing: true,
                ajax: {
                    url: "default.aspx/GetShowcases",
                    type: "POST",
                    ...
                    data: function (d) {
                        return JSON.stringify({
                            ...
                            brandId: $("#<%= BrandFilter.ClientID %>").val(),
            ...
            window.deleteShowcase = function (id) {
                if (!confirm("Xóa thương hiệu tiêu biểu này?")) {
                    return;
                }

                $.ajax({
                    url: "default.aspx/DeleteShowcase",
                    type: "POST",
                    contentType: "application/json; charset=utf-8",
