<%@ Page Language="C#" AutoEventWireup="true" CodeFile="products.aspx.cs" Inherits="SellerProducts" MasterPageFile="~/seller/Seller.master" ContentType="text/html; charset=utf-8" ResponseEncoding="utf-8" %>
    ...
    <div class="seller-products">
        ...
        <div class="product-tabs card">
            <div class="return-tabs product-tab-row">
                <a class="tab <%# GetTabClass("all") %>" href="/seller/products.aspx?status=all">Tất cả (<asp:Literal ID="TabAllLiteral" runat="server" />)</a>
                <a class="tab <%# GetTabClass("active") %>" href="/seller/products.aspx?status=active">Đang bán (<asp:Literal ID="TabActiveLiteral" runat="server" />)</a>
                <a class="tab <%# GetTabClass("hidden") %>" href="/seller/products.aspx?status=hidden">Tạm ẩn (<asp:Literal ID="TabHiddenLiteral" runat="server" />)</a>
                <a class="tab <%# GetTabClass("out") %>" href="/seller/products.aspx?status=out">Hết hàng (<asp:Literal ID="TabOutLiteral" runat="server" />)</a>
            </div>
