...
<asp:Content ID="SubHeadingContent" ContentPlaceHolderID="PageSubHeading" runat="server">
    Tạo và quản lý tag từ khóa cho bài viết
</asp:Content>
<asp:Content ID="BreadcrumbContent" ContentPlaceHolderID="PageBreadcrumb" runat="server">
    ...
    <li class="breadcrumb-item active" aria-current="page">Tag bài viết</li>
</asp:Content>
...
<asp:Content ID="MainContent" ContentPlaceHolderID="MainContent" runat="server">
    <div class="card-kpi p-3 bg-white">
        ...
        <div class="d-flex justify-content-between align-items-center mb-3">
            <h6 class="mb-0 section-title">Danh sách tag</h6>
            <a class="btn btn-primary btn-with-icon" href="/admin/cms/tags/edit.aspx">
        ...
        <div class="table-responsive">
            <table id="cmsTagTable" class="table table-striped align-middle">
                <thead>
                    <tr>
                        <th>Tag</th>
                        <th>Slug</th>
...
<asp:Content ID="PageScripts" ContentPlaceHolderID="PageScripts" runat="server">
    ...
    <script>
        (function ($) {
            ...
            var table = $("#cmsTagTable").DataTable({
                pageLength: 25,
                order: [[3, "asc"]],
                serverSide: true,
                processing: true,
                ...
                columns: [
                    { data: "TagName" },
                    { data: "SlugHtml", orderable: false, searchable: false },
                    { data: "ViewCount" },
                    { data: "SortOrder" },
                ...
                columnDefs: [
                    { targets: [1, 4, 5], render: function (data) { return data; } },
            ...
            window.deleteCmsTag = function (id) {
